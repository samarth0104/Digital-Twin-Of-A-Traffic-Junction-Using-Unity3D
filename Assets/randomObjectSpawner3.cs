...
public class RandomObjectSpawner3 : MonoBehaviour
{
    ...
    void Start()
    {
        spawnCountFilePath = Application.dataPath + "/spawn_count3.txt"; // Path to the text file
    ...
    IEnumerator SpawnObjectsRepeatedly()
    {
        while (true)
        {
            ...
            for (int i = 0; i < spawnCount; i++)
            {
                ...
                Vector3 randomSpawnPosition = new Vector3(4.7f, 0.78f, 75.9f);
