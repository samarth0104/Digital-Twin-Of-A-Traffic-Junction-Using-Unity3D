...
public class RandomObjectSpawner4 : MonoBehaviour
{
    ...
    void Start()
    {
        spawnCountFilePath = Application.dataPath + "/spawn_count4.txt"; // Path to the text file
    ...
    IEnumerator SpawnObjectsRepeatedly()
    {
        while (true)
        {
            ...
            for (int i = 0; i < spawnCount; i++)
            {
                ...
                Vector3 randomSpawnPosition = new Vector3(60.1f, 0.78f, -2.3f);
